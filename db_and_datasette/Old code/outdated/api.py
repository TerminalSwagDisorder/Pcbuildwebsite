...
print("Extracting data and printing it")
...
# The prices will now be in EURO (€)
...
for cpu_cooler in cpu_cooler_info_2:
    print(cpu_cooler["name"], ":", cpu_cooler["price"])
...
for motherboard in motherboard_info_2:
    print(motherboard["name"], ":", motherboard["price"])
...
for wireless in wireless_info_2:
    print(wireless["name"], ":", wireless["price"])
